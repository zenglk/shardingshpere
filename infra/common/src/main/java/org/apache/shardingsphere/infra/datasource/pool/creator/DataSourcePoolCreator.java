...
import org.apache.shardingsphere.infra.datasource.pool.metadata.type.druid.DruidDataSourcePoolMetaData;
...
public final class DataSourcePoolCreator {
    ...
    public static DataSource create(final DataSourceProperties dataSourceProps) {
        ...
        if (poolMetaData.isPresent()) {
            if (poolMetaData.get() instanceof DruidDataSourcePoolMetaData) {
                CustomDataSourceProperties customDataSourceProperties = dataSourceProps.getCustomDataSourceProperties();
                customDataSourceProperties.getProperties().forEach(dataSourceReflection::setField);
            } else {
    ...
    private static void appendJdbcUrlProperties(final CustomDataSourceProperties customDataSourceProps, final DataSource targetDataSource,
